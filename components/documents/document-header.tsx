          ...
          {isAIEnabled &&
            ...
            (prismaDocument.agentsEnabled ? (
              <ButtonTooltip content="AI Agents Settings">
                ...
                >
                  <NobridgeSparkle className="h-5 w-5 text-emerald-500" />
                </Button>
              </ButtonTooltip>
            ) : (
              <ButtonTooltip content="Enable AI Agents">
                ...
                >
                  {enablingAI ? (
                    ...
                    <NobridgeSparkle className="h-5 w-5" />
                  )}
                </Button>
              </ButtonTooltip>
            ))}
            ...
            >
              ...
              {isAIEnabled &&
                ...
                (prismaDocument.agentsEnabled ? (
                  ...
                  >
                    <NobridgeSparkle className="mr-2 h-4 w-4 text-emerald-500" />
                    AI Agents Settings
                  </DropdownMenuItem>
                ) : (
                  <DropdownMenuItem
                    ...
                    disabled={enablingAI}
                  >
                    <NobridgeSparkle className="mr-2 h-4 w-4" />
