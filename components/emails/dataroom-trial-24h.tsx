...
const DataroomTrial24hReminderEmail = ({ name }: TrialEndReminderEmail) => {
  return (
    <Html>
      <Head />
      <Preview>Upgrade to Nobridge Data Rooms Plan</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm leading-6 text-black">
              Your Nobridge Data Room plan trial expires in 24 hours.
              Don&apos;t lose access to these features -{" "}
              <Link href={`https://room.nobridge.co/settings/billing`}>
                upgrade today
              </Link>
              :
            </Text>
            ...
            <Section className="mb-[32px] mt-[32px] text-center">
              <Button
                ...
                href={`https://room.nobridge.co/settings/billing`}
            ...
            <Text className="text-sm text-gray-400">Marc from Nobridge</Text>
            <Footer />
          </Container>
        </Body>
      </Tailwind>
