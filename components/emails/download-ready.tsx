...
export default function DownloadReady({
  ...
  downloadUrl = "https://room.nobridge.co",
          ...
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm leading-6 text-black">
              {isViewer
                ...
                : "Click the button below to download your files. You'll need to be logged in to your Nobridge account to access the download."}
            </Text>
