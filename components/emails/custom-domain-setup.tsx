...
export default function CustomDomainSetup({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your Nobridge custom domain set up</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <ol className="list-inside list-decimal text-sm">
              ...
              <li>Add a CNAME record pointing to nobridge.co</li>
              <li>Configure the domain in your Nobridge settings</li>
            ...
            <Section className="my-8 text-center">
              {hasAccess ? (
                <Button
                  ...
                  href={`https://room.nobridge.co/settings/domains`}
                ...
                <Button
                  className="rounded bg-black text-center text-xs font-semibold text-white no-underline"
                  href={`https://room.nobridge.co/settings/upgrade`}
                  style={{ padding: "12px 20px" }}
                >
            ...
            <Text className="text-sm leading-6 text-black">
              {hasAccess ? (
                <>
                  ...
                  <Link
                    href="https://docs.nobridge.co/custom-domains"
