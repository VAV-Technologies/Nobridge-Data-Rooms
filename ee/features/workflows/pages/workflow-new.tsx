...
export default function NewWorkflowPage() {
  ...
  const [domain, setDomain] = useState<string>("nobridge.co");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (domain !== "nobridge.co" && !slug.trim()) {
    ...
    try {
      const response = await fetch(`/api/workflows?teamId=${teamId}`, {
        ...
        body: JSON.stringify({
          ...
          domain: domain === "nobridge.co" ? undefined : domain,
          slug: domain === "nobridge.co" ? undefined : slug.trim(),
        }),
      });
        ...
        <div className="max-w-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={domain} onValueChange={setDomain}>
                  <SelectTrigger id="domain">
                    <SelectValue placeholder="nobridge.co (default)" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="nobridge.co">nobridge.co</SelectItem>
                    {domains?.map((d) => (
              ...
              {domain === "nobridge.co" && (
                <p className="text-xs text-muted-foreground">
                  Entry URL will be generated automatically (e.g., nobridge.co/view/clxxx...)
                </p>
              )}
            </div>
