...
export default function DataroomNotification({
  ...
  url = "https://room.nobridge.co/datarooms/123",
  unsubscribeUrl = "https://room.nobridge.co/datarooms/123/unsubscribe",
}: {
  dataroomName: string;
      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm text-gray-400">Nobridge</Text>
            ...
            <Section className="text-gray-400">
              ...
              <Text className="text-xs">
                ...
                Nobridge. If you have any feedback or questions about this
