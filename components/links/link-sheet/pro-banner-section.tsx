...
export function ProBannerSection({
  ...
  return (
    <div className="pb-5">
      <LinkItem
        title="Show Secured by Nobridge"
        tooltipContent="Display 'Secured by Nobridge' branding on your shared documents"
        link="https://www.nobridge.co/help/article/remove-nobridge-branding"
        enabled={enabled}
