  ...
  return (
    <div className="pb-5">
      <LinkItem
        ...
        link="https://www.nobridge.co/help/article/change-social-media-cards"
          ...
          <div>
            ...
            <div className="relative mt-1 flex rounded-md shadow-sm">
              ...
              <Input
                ...
                placeholder={`Nobridge - open-source document sharing infrastructure.`}
                value={metaTitle || ""}
                onChange={(e) => {
          ...
          <div>
            ...
            <div className="relative mt-1 flex rounded-md shadow-sm">
              ...
              <Textarea
                ...
                maxLength={240}
                className="focus:ring-inset"
                placeholder={`Nobridge is an open-source document sharing infrastructure for modern teams.`}
