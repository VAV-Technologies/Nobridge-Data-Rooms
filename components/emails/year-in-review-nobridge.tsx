...
interface NobridgeYearInReviewEmailProps {
  year: number;
...
export default function NobridgeYearInReviewEmail({
  year = 2024,
  ...
  unsubscribeUrl,
}: NobridgeYearInReviewEmailProps) {
  return (
    <Html>
      <Head />
          ...
          <Container className="mx-auto w-full max-w-[600px] p-0">
            <Section className="p-8 text-center">
              ...
              <Heading className="my-4 text-4xl font-medium leading-tight">
                Your Year with Nobridge
              </Heading>
              <Text className="mb-8 text-lg leading-8">
                What a year it&apos;s been! Let&apos;s take a look at how
                you&apos;ve used Nobridge to share your important documents.
              </Text>
              <Link
                href={`https://x.com/intent/post?text=In%202024%2C%20my%20documents%20have%20been%20viewed%20${minutesSpentOnDocs}%20minutes%20on%20%40nobridgeio%2C%20by%3A%0A%0A%E2%80%A2%20Uploading%20${uploadedDocuments}%20documents%0A%E2%80%A2%20Sharing%20${sharedLinks}%20links%0A%E2%80%A2%20Receiving%20${receivedViews}%20views%0A%0A&url=https%3A%2F%2Fwww.nobridge.co%2Fyear-in-review`}
            ...
            <Section className="pb-6 text-center">
              <Text className="text-xl leading-8 text-gray-900">
                ...
                Happy Holidays from the Nobridge team :)
              </Text>
              <Link
                href={`https://x.com/intent/post?text=In%202024%2C%20my%20documents%20have%20been%20viewed%20${minutesSpentOnDocs}%20minutes%20on%20%40nobridgeio%2C%20by%3A%0A%0A%E2%80%A2%20Uploading%20${uploadedDocuments}%20documents%0A%E2%80%A2%20Sharing%20${sharedLinks}%20links%0A%E2%80%A2%20Receiving%20${receivedViews}%20views%0A%0A&url=https%3A%2F%2Fwww.nobridge.co%2Fyear-in-review`}
              ...
              <Link
                href="https://room.nobridge.co/documents"
            ...
            <Section className="mt-8 text-gray-400">
              ...
              <Text className="text-xs">
                ...
                account with Nobridge during 2024. If you have any feedback or
