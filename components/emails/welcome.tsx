...
const WelcomeEmail = ({ name }: WelcomeEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>Welcome to Nobridge</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[600px] rounded border border-solid border-neutral-200 px-10 py-5">
            ...
            <Heading className="mx-0 my-7 p-0 text-xl font-semibold text-black">
              Welcome {name ? name : "to Nobridge"}!
            </Heading>
            <Text className="mb-8 text-sm leading-6 text-gray-600">
              Thank you for signing up for Nobridge! You can now start sharing
            ...
            <Text className="mb-4 text-sm leading-6 text-gray-600">
              ...
              : Simply{" "}
              <Link
                href="https://www.nobridge.co/help/article/how-to-upload-document"
            ...
            <Text className="mb-4 text-sm leading-6 text-gray-600">
              ...
              : Add{" "}
              <Link
                href="https://www.nobridge.co/help/article/require-email-verification"
                className="font-semibold text-black underline underline-offset-4"
              >
                email verification
              </Link>
              ,{" "}
              <Link
                href="https://www.nobridge.co/password-protection"
                className="font-semibold text-black underline underline-offset-4"
              >
                password protection
              </Link>
              , or{" "}
              <Link
                href="https://www.nobridge.co/help/article/expiration-date"
                className="font-semibold text-black underline underline-offset-4"
              >
                link expiration
              </Link>{" "}
            ...
            <Text className="mb-4 text-sm leading-6 text-gray-600">
              ...
              : Watch{" "}
              <Link
                href="https://www.nobridge.co/help/article/built-in-page-by-page-analytics"
                className="font-semibold text-black underline underline-offset-4"
              >
            ...
            <Text className="mb-8 text-sm leading-6 text-gray-600">
              ...
              :{" "}
              <Link
                href="https://www.nobridge.co/help/article/create-data-room"
                className="font-semibold text-black underline underline-offset-4"
              >
